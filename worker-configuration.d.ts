/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: a85f56acdbe7e1758d80b3c700039f40)
...
interface __BaseEnv_Env {
	...
	ADMIN_PUSHDEER_KEY: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./ts/main");
	}
